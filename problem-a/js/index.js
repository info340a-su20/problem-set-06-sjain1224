...
function renderTrack(song){
  ...
  songPic.src = song.artworkUrl100;
  songPic.alt = song.trackName;
  songPic.title = song.trackName;
  recordDiv.appendChild(songPic);
  //console.log(songPic);
}
...
function renderError(error){
  ...
  recordDiv.appendChild(errorElem);
}
...
function togglerSpinner(){
  let spinnerClass = document.querySelector('.fa-spinner');
  spinnerClass.classList.toggle('d-none');
}
